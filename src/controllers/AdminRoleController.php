...
use itlo\cms\rbac\models\AuthItem;
use itlo\cms\rbac\models\CmsAuthItem;
use itlo\cms\rbac\models\searchs\AuthItem as AuthItemSearch;
...
class AdminRoleController extends BackendModelStandartController
{
    ...
    {
        $this->name = \Yii::t('itlo/rbac', "Managing roles");
        ...
        $this->accessCallback = function () {
            if (!\Yii::$app->itlo->site->is_default) {
                return false;
            }
